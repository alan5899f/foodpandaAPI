//
//  FoodDeliveryCollectionViewCellSectionTwo.swift
//  foodpandaAPI
//
...
class FoodDeliveryCollectionViewCellSectionTwo: UICollectionViewCell {
    
    static let identifier = "FoodDeliveryCollectionViewCellSectionTwo"
    ...
    private func setupLayout() {
        ...
        foodTime.backgroundColor = .systemGray6
        ...
        foodImage.anchor(top: contentView.topAnchor, left: contentView.leftAnchor, right: contentView.rightAnchor, height: contentView.height * 0.6, topPadding: 10, leftPadding: 10, rightPadding: 10)
        foodLabel.anchor(top: foodImage.bottomAnchor, left: foodImage.leftAnchor, right: contentView.rightAnchor, topPadding: 10)
    ...
    private func attributed(title: String, describe: String, deliveryFee: String) {
        ...
        attributed1.addAttribute(.font, value: UIFont.systemFont(ofSize: 14, weight: .bold), range: NSMakeRange(0, stringCount1))
        
        let stringCount2 = describe.count
        let attributed2 = NSMutableAttributedString(string: describe + "\n")
        attributed2.addAttribute(.font, value: UIFont.systemFont(ofSize: 14, weight: .regular), range: NSMakeRange(0, stringCount2))
    ...
    override func prepareForReuse() {
        ...
        foodImage.image = nil
        foodTime.setTitle(nil, for: .normal)
        foodLabel.text = nil
        backgroundColor = .white
    }
